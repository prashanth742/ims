...
<img src="\ims\image\Screenshot (1)(1).png" alt="iso" id="aja" width="412" height="270" style="position: absolute; left: 180px; top: 146px"/>
<img src="\ims\image\Dimen.jpg" alt="iso" id="aja" width="412" height="273" style=" position: absolute;width:500px; left: 680px; top: 146px"/>
...
<table width="994"  border="1" style="position: absolute; left: 89px; top: 465px; height: 300px; ">
...
<table width="994" height="207" border="1" style="position: absolute; left: 89px; top: 790px; height: 175px;">
  <tr>
...
<table width="994" height="298" border="1" style="position: absolute; left: 89px; top: 968px; height: 290px; ">
  <tr>
...
<table width="994" height="207" border="1" style="position: absolute; left: 89px; top: 1342px; height: 181px;">
  <tr>
...
<table width="994"  border="1" style="position: absolute; left: 89px; top: 1548px; height: 100px;">
  <tr>
...
<table width="994"  border="1" style="position: absolute; left: 89px; top: 1675px; height: 41px;">
 ...
 function changetocolor22(color){
  ...
  document.getElementById("readcolor1").value = color;
           ...
           <button type ="submit" align="center" onclick="changetocolor22('yellow')" style="position:absolute;top:1750px;text-align: left;width:70px;left:500px;"id="btnimp"  name="save"  class="btn btn-danger">Submit</button>
           <button type ="submit" align="center" onclick="changetocolor22('red')" style="position:absolute;top:1750px;text-align: left;width:70px;left:630px;"id="btnssaimp"  name="sasave"  class="btn btn-danger">Finish</button>
                </div>
</form>
        </div>
