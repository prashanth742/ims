...
<img src="..\image\aocu3.png" style="position: absolute; left: 853px; top: 788px;height:265px; width: 242px;" />
<img src="..\image\aocu4.png" style="position: absolute; left: 853px; top: 1068px;height:315px; width: 252px;" />
<img src="..\image\fignew.png" style="position: absolute; left: 853px; top: 1400px;height:205px; width: 242px;" />
<img src="..\image\aocu6.png" style="position: absolute; left: 853px; top: 1650px;height:105px; width: 222px;" />
...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 234px; height: 181px;font-weight: bold; font-size: 18px;">
  ...
  <tr>
    ...
    <td><input style="width:200px;" type="text"value="<?php echo $row->RearNumberPlate;?>" name="rearnumberplate" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td   height="27" align="center">7</td>
    <td style="font: bold 20px Times New Roman">Hazchem Plate</td>
    <td><input style="width:200px;" type="text" value="<?php echo $row->RearHazchemPlate ?>" name="rearhazchemplate" width ="70%"id="fe16" /></td>
  </tr>
</table>
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top: 468px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  <tr>
    ...
    <td   style="font: bold 20px Times New Roman" width="181"><input style="width:200px;" type="text"value="<?php echo $row->LHSFrontDiagonalTop ?>" name="LHSFrontDiagonalTop" width ="70%"id="fe16" /></td>
    
  </tr>
  <tr>
    <td  valign="right" align="center">9</td>
    <td  style="font: bold 20px Times New Roman">Front Diagonal-Bottom</td>
    <td  style="font: bold 20px Times New Roman"><input style="width:200px;" type="text"value="<?php echo $row->LHSFrontDiagonalBottom ?>" name="LHSFrontDiagonalBottom" width ="70%"id="fe16" /></td>
  
  </tr>
  <tr>
    <td align="center">10</td>
    <td  style="font: bold 20px Times New Roman">Front Diagonal-Inner</td>
    <td  style="font: bold 20px Times New Roman"><input style="width:200px;" type="text"value="<?php echo $row->LHSFrontDiagonalInner?>" name="LHSFrontDiagonalInner" width ="70%"id="fe16" /></td>
  ...
  <tr>
    ...
    <td style="font: bold 20px Times New Roman"><input style="width:200px;" type="text" value="<?php echo $row->LHSRearDiagonalInner ?>"name="LHSRearDiagonalInner" width ="70%"id="fe16" /></td>
    
  </tr>
  <tr>
    <td  align="center">13</td>
    <td style="font: bold 20px Times New Roman">Rear Diagonal-Bottom</td>
    <td style="font: bold 20px Times New Roman"><input style="width:200px;" type="text" value="<?php echo $row->LHSRearDiagonalBottom ?>"name="LHSRearDiagonalBottom" width ="70%"id="fe16" /></td>
 
  </tr>
  <tr>
    <td   height="27" align="center">14</td>
    <td>Middle Side Rail</td>
    <td style="font: bold 20px Times New Roman"><input style="width:200px;" type="text" value="<?php echo $row->LHSMiddleSideRail ?>"name="LHSMiddleSideRail" width ="70%"id="fe16" /></td>
    
  </tr>
    <tr>
    <td align="center" style="font: bold 20px Times New Roman">15</td>
    <td>Rear Diagonal-Top</td>
    <td><input style="width:200px;" type="text"value="<?php echo $row->LHSRearDiagonalTop?>" name="LHSRearDiagonalTop" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Step Rail</td>
    <td><input style="width:200px;" type="text"value="<?php echo $row->LHSStepRail ?>" name="LHSStepRail" width ="70%"id="fe16" /></td>
  </tr>
</table>

<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 804px; height: 181px;font-weight: bold; font-size: 18px;">
  <tr>
  ...
  <tr>
    ...
    <td style="font: bold 20px Times New Roman">Number Plate</td>
    <td><input style="width:200px;" type="text"value="<?php echo $row->frontnumberplate ?>" name="frontnumberplate" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td   height="27" align="center">24</td>
    <td style="font: bold 20px Times New Roman">Hazchem Plate</td>
    <td><input style="width:200px;" type="text"value="<?php echo $row->fronthazchemplate?>" name="fronthazchemplate" width ="70%"id="fe16" /></td>
  </tr>
</table>
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top: 1048px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  <tr>
    ...
    <td   style="font: bold 20px Times New Roman" width="231">Front Diagonal-Top</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input style="width:200px;" type="text"value="<?php echo $row->rhsfrontdiagonaltop ?>" name="rhsfrontdiagonaltop" width ="70%"id="fe16" /></td>
    
  </tr>
  <tr>
    <td  valign="right" align="center">26</td>
    <td  style="font: bold 20px Times New Roman">Front Diagonal-Bottom</td>
    <td  style="font: bold 20px Times New Roman"><input style="width:200px;" type="text"value="<?php echo $row->rhsfrontdiagonalbottom ?>" name="rhsfrontdiagonalbottom" width ="70%"id="fe16" /></td>
  ...
  <tr>
    ...
    <td  style="font: bold 20px Times New Roman">Front Diagonal-Inner</td>
    <td  style="font: bold 20px Times New Roman"><input style="width:200px;" type="text"value="<?php echo $row->rhsfrontdiagonalinner ?>" name="rhsfrontdiagonalinner" width ="70%"id="fe16" /></td>
  ...
  <tr>
    ...
    <td style="font: bold 20px Times New Roman">Rear Diagonal-Inner</td>
    <td style="font: bold 20px Times New Roman"><input style="width:200px;" type="text"value="<?php echo $row->rhsreardiagonalinner ?>" name="rhsreardiagonalinner" width ="70%"id="fe16" /></td>
    
  </tr>
    <tr>
    <td  valign="right" align="center">30</td>
    <td  style="font: bold 20px Times New Roman">Rear Diagonal-Bottom</td>
    <td  style="font: bold 20px Times New Roman"><input style="width:200px;" type="text"value="<?php echo $row->rhsreardiagonalbottom?>" name="rhsreardiagonalbottom" width ="70%"id="fe16" /></td>
  
  </tr>
  <tr>
    <td  align="center">31</td>
    <td style="font: bold 20px Times New Roman">Middle Side Rail</td>
    <td style="font: bold 20px Times New Roman"><input style="width:200px;" type="text"value="<?php echo $row->rhsmiddlesiderail ?>" name="rhsmiddlesiderail" width ="70%"id="fe16" /></td>
 
  </tr>
  <tr>
    <td   height="27" align="center">32</td>
    <td>Rear Diagonal-Top</td>
    <td style="font: bold 20px Times New Roman"><input style="width:200px;" type="text"value="<?php echo $row->rhsreardiagonaltop?>" name="rhsreardiagonaltop" width ="70%"id="fe16" /></td>
  ...
  <tr>
    ...
    <td>Step Rail</td>
    <td><input style="width:200px;" type="text"value="<?php echo $row->rhssteprail?>" name="rhssteprail" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 1424px; height: 181px;font-weight: bold; font-size: 18px;">
  ...
  <tr>
    ...
    <td><input style="width:200px;" type="text"value="<?php echo $row->TopLHTopSideRail?>" name="TopLHTopSideRail" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td align="center">39</td>
    <td  style="font: bold 20px Times New Roman">RH Top side Rail</td>
    <td><input style="width:200px;" type="text"value="<?php echo $row->TopRHTopSideRail?>" name="TopRHTopSideRail" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input style="width:200px;" type="text"value="<?php echo $row->TopRollOverTubeRear?>" name="TopRollOverTubeRear" width ="70%"id="fe16" /></td>
  </tr>
 <tr>
  
    <td width="78" align="center">43</td>
    <td   style="font: bold 20px Times New Roman" width="231">Roll over tube front</td>
    <td width="199"><input style="width:200px;" type="text"value="<?php echo $row->BottomRollOverTubeFront ?>" name="BottomRollOverTubeFront" width ="70%"id="fe16" /></td>
  </tr>
</table>
<table width="760"  border="1" style="position: absolute; left: 89px; top: 1674px; height: 81px;font-weight: bold; font-size: 18px;">
  ...
  <tr>
    ...
    <td><input style="width:200px;" type="text"value="<?php echo $row->BottomBottomCrossBeam ?>" name="BottomBottomCrossBeam" width ="70%"id="fe16" /></td>
  </tr>
